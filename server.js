...
const PERIMETER =
  generatePerimeter(ARENA_SIZE, CORNER_RADIUS, 300);
...
async function wipeAll() {
  ...
  if (
    confirm(
      'Wipe ALL player data? This cannot be undone!'
    )
  ) {
